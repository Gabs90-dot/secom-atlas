...
import type {
  ...
  PublicCustomerOption,
  TicketFormSourceCustomer,
  TicketFormSourceSite,
} from "@/lib/atlasCustomerTypes";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Evita che un profilo interno resti sul Portale Clienti
    // dopo il caricamento o il refresh del profilo utente.
    setActiveTab((current) => (current === "customerPortal" ? "home" : current));
    setMobileView((current) => (current === "customerPortal" ? "home" : current));
